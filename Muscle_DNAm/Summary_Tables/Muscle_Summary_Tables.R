...
load(here::here("Output/Data/Corcoran_Pipeline", "CALERIE_Muscle_Corcoran_data.Rdata"))
...
summarize_betas <- function(betas, visit_id, filename_suffix) {
  ...
  write_csv(summary_df, here::here("Output/Data/DNAm_Summary_Info", paste0("CALERIE_Muscle_", filename_suffix, "_bval_summary_all_probes.csv")))
